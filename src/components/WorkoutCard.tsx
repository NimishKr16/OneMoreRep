...
export default function WorkoutCard({
  ...
  return (
    <div
      ...
      className={`h-full min-h-20 rounded-xl border border-gray-800 bg-linear-to-br from-gray-900 to-gray-950 p-5 text-left transition-all group flex flex-col ${
        onClick
